  ...
  function tickInterval(interval$$1, start, stop, step) {
    ...
    if (typeof interval$$1 === "number") {
      ...
      if (i === tickIntervals.length) {
        ...
        step = Math.max(tickStep(start, stop, interval$$1), 1);
...
var pointsGroup = plotGroup.append('g')
    .classed('points', true);
json('https://api.reddit.com', function (error, data) {
    if (error) {
        console.error(error);
    }
    else {
        ...
        xScale.domain(extent(prepared, function (d) { return d.date; }))
            .nice();
        xAxisGroup.call(xAxis);
        yScale.domain(extent(prepared, function (d) { return d.score; }))
            .nice();
